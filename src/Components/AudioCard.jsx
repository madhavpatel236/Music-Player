...
function AudioCard() {
  ...
  const handlenextBtn = () => {
    ...
    dispatch(showSongInfo(allSongs[nextIndex]));
  };
  ...
  return (
    ...
    <div class=" fixed bg-red-950 mr-12 flex justify-center items-center h-screen">
      <div class="bg-white p-8 rounded-lg shadow-md w-80">
        {/* <!-- Album Cover (image) --> */}
        <img
          src={song?.album?.images[1]?.url || logo}
        ...
        <div class="mt-6 flex justify-center items-center">
          ...
          <button class="p-4 rounded-full bg-gray-200 hover:bg-gray-300 focus:outline-none mx-4">
            <svg
              width="64px"
              height="64px"
              viewBox="0 0 24 24"
